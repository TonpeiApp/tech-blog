const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/profile.php?id=61565833225898',
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/tompedia_project/',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    <footer className="bg-white border-t-2 border-gray-200 shadow-sm bg-white/90 backdrop-blur-sm transition-all duration-300 hover:shadow-md">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-10 lg:px-8">
        ...
        <p className="mt-10 text-center text-sm/6 text-gray-600">
          &copy; 2024 とんペディアプロジェクト. All rights reserved.
        </p>
      </div>
    </footer>
  );
